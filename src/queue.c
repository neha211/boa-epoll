...
void block_request(request * req)
{
    ...
    if (req->buffer_end) {
#if defined _epoll
		EPOLL_CTL(req->fd, EPOLLOUT, EPOLL_CTL_ADD);
#elif defined _kqueue
		KEV_CTL(req->fd, EVFILT_WRITE, EV_ADD);
#else         
        ...
        case PIPE_READ:
#if defined _epoll
			EPOLL_CTL(req->data_fd, EPOLLIN, EPOLL_CTL_ADD);
#elif defined _kqueue
			KEV_CTL(req->data_fd, EVFILT_READ, EV_ADD);
#else         
        ...
        case BODY_WRITE:
#if defined _epoll
			EPOLL_CTL(req->post_data_fd, EPOLLOUT, EPOLL_CTL_ADD);
#elif defined _kqueue
			KEV_CTL(req->post_data_fd, EVFILT_WRITE, EV_ADD);
#else         
        ...
        default:
#if defined _epoll
			EPOLL_CTL(req->fd, EPOLLIN, EPOLL_CTL_ADD);
#elif defined _kqueue
			KEV_CTL(req->fd, EVFILT_READ, EV_ADD);
#else 
...
void ready_request(request * req)
{
    ...
    if (req->buffer_end) {
#if defined _epoll
		EPOLL_CTL(req->fd, EPOLLOUT, EPOLL_CTL_DEL);
#elif defined _kqueue
		KEV_CTL(req->fd, EVFILT_WRITE, EV_DELETE);
#else
        ...
        case PIPE_READ:
#if defined _epoll
			EPOLL_CTL(req->data_fd, EPOLLIN, EPOLL_CTL_DEL);
#elif defined _kqueue
			KEV_CTL(req->data_fd, EVFILT_READ, EV_DELETE);
#else         
        ...
        case BODY_WRITE:
#if defined _epoll
			EPOLL_CTL(req->post_data_fd, EPOLLOUT, EPOLL_CTL_DEL);
#elif defined _kqueue
			KEV_CTL(req->post_data_fd, EVFILT_WRITE, EV_DELETE);
#else         
	...
	default:
#if defined _epoll
			EPOLL_CTL(req->fd, EPOLLIN, EPOLL_CTL_DEL);
#elif defined _kqueue
			KEV_CTL(req->fd, EVFILT_READ, EV_DELETE);
#else         
