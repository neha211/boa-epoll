...
#if __linux
    extern int efd;				/* epoll fd */
    extern struct epoll_event event; 	/* to register events for new fd */
#endif

#if __APPLE__
    extern int kqfd;			/* kqueue fd */
    extern struct kevent event;		/* event structure */
#endif
